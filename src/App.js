      ...
      <div className="container-fluid text-center">
        ...
        <div className='row bg-light'>
          <div class="col-12 col-sm-6">
            ...
            <p class="justify-content-lg-center align-items-center text-center px-4 py-1">I have over 4 years of professional experience as a software engineer. Currently, I am a Full Stack developer working with internal and external Tools applications. I also serve as the Scrum Master for my team to facilitate scrum activities, drive discussions and resolutions, improve processes, and work cross-functionally to unblock impediments to help deliver on commitments. In our primary app, I utilize Ruby/Ruby on Rails for back-end services in tandem with JavaScript, React and TypeScript for the front-end. In another app, I use NodeJS for back-end along with React/JS on the front-end. Previously, I worked for 2 years to help create, maintain and update back-end microservices built with NodeJS and JavaScript for Fintech companies. My soft skills are top notch from working over 10 years in outside sales prior to becoming a software engineer. I am especially proud of my ability to work independently or collaboratively as part of a team and I am an excellent communicator. I also have proficiency in graphic design to create digital media, logos, branding and more utilizing Adobe Photoshop and Illustrator.
            </p>
